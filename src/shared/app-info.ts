...
export const APP_UPDATES = [
  ...
  'Menu Produk BGY dan running text promosi singkat.',
  'Bantuan, kritik dan saran melalui WhatsApp.',
  'Panduan mulai cepat untuk pengguna baru.',
  'Pengingat backup data setiap 30 hari.',
]
