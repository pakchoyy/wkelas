...
export default function Jurnal() {
  ...
  return <div className="space-y-4">
    ...
    <section className="rounded-2xl border border-slate-200 bg-gradient-to-r from-slate-50 via-white to-emerald-50 p-5 shadow-sm"><div className="mb-4 text-center"><h3 className="font-extrabold tracking-wide text-slate-900">IDENTITAS JURNAL MENGAJAR</h3><p className="mt-1 text-xs text-slate-500">{identity.sekolah}</p></div><div className="grid grid-cols-2 gap-x-8 gap-y-2 text-sm lg:grid-cols-4"><div><span className="text-slate-400">Kelas</span><strong className="ml-2 text-slate-700">{identity.kelas}</strong></div><div><span className="text-slate-400">Semester</span><strong className="ml-2 text-slate-700">{identity.semester}</strong></div><div><span className="text-slate-400">Tahun Pelajaran</span><strong className="ml-2 text-slate-700">{identity.tahun}</strong></div><div><span className="text-slate-400">Guru</span><strong className="ml-2 text-slate-700">{identity.guru}</strong></div></div></section>
