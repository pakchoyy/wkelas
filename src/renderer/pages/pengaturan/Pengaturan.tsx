...
function PengaturanKelas({kelasId}:{kelasId:number}) {
  ...
  return <div className="mx-auto max-w-4xl space-y-4">
    ...
    <section aria-label="Paket akun" className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-teal-200 bg-teal-50 p-4"><div className="flex min-w-0 items-start gap-3"><span className="grid size-10 shrink-0 place-items-center rounded-xl bg-teal-600 text-white"><Sparkles size={18}/></span><div className="min-w-0"><h3 className="font-extrabold text-teal-900">Paket Gratis</h3><p className="mt-0.5 text-sm text-teal-800">Semua fitur masih terbuka selama masa pengembangan.</p></div></div><Link to="/aktivasi-pro" className="inline-flex min-h-11 items-center rounded-xl border border-teal-200 bg-white px-4 text-sm font-bold text-teal-800 hover:bg-teal-100">Lihat Pro</Link></section>
