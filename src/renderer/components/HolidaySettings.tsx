...
export default function HolidaySettings({kelasId,onChanged}:{kelasId:number;onChanged:()=>void}) {
  ...
  return <div className="space-y-3">
    <p className="text-sm text-slate-600">Kalender Jatim 2026/2027 terisi otomatis (1 Jul 2026 – 30 Jun 2027). Edit manual di Kelola kalender bila ada penyesuaian lokal.</p>
