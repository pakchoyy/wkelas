  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/pengaturan" aria-label={`Buka profil ${nama}`} title={nama} className="flex min-h-11 max-w-[42%] shrink-0 items-center gap-2 rounded-xl px-2 text-white hover:bg-white/15">
